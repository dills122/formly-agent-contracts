...
description: Deterministic, agent-readable contracts for Angular Formly forms.
template: splash
hero:
...
<section class="capability-band" aria-label="Current and planned boundaries">
  ...
  <div>
    <h2>Not shipped</h2>
    <p>A production MCP server, automatic Playwright generation, executable application-specific drivers, and live-browser observation remain future layers.</p>
  </div>
</section>
